...
ITENS_FINANCEIRO = ["PECAS", "M.O.", "M.O. OPERADOR", "DIESEL", "OUTROS", "PNEU", "CAMARA DE AR", "PROTETOR DE PNEU"]
TIPOS_MANUTENCAO = ["HIDRAULICO", "ELETRICO", "MOTOR", "TDP", "OUTROS","BORRACHARIA", "CAMBIO", "DIFERENCIAL"]
